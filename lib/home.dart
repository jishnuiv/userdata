              ...
              children: [
                ...
                Column(
                  children: [
                    ...
                    ListTile(
                      leading: Text("Gender"),
                      trailing: Text("${Details.gender!}"),
                    ),
                    ListTile(
                      leading: Text("Date Of Birth"),
                      trailing: Text("${Details.dateOfBirth!}"),
                    ),
                    ListTile(
                      leading: Text("Email"),
                      trailing: Text("${Details.email!}"),
                    ),
                    ListTile(
                    ...
                    ListTile(
                      leading: Text("Register Date"),
                      trailing: Text("${Details.registerDate!}"),
                    ),
                    ListTile(
                      leading: Text("Updated Date"),
                      trailing: Text("${Details.updatedDate!}"),
                    ),
                    Row(
                      children: [
                        Padding(
                        ...
                        Column(
                          children: [
                            ...
                            Text("Street:${Details.location!.street}")
                          ],
                        ),
                      ],
